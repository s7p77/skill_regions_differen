...
class Workspace:
    ...
    def setup_wandb(self):
        ...
        wandb.init(project=cfg.project_name, group=cfg.agent.name + "_image", name=exp_name)
    ...
    def load_snapshot(self):
        ...
        for k, v in payload.items():
            ...
            if k == 'wandb_run_id':
                ...
                wandb.init(project=cfg.project_name + "_pretrain", group=cfg.agent.name, name=exp_name, id=v,
                           resume=True)
