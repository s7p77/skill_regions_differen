...
class Workspace:
    def __init__(self, cfg):
        ...
        if cfg.use_wandb:
            ...
            wandb.init(project=cfg.project, group=cfg.agent.name, name=exp_name)
    ...
    def train(self):
        ...
        while train_until_step(self.global_step):
            ...
            if hasattr(self.agent, "regress_meta"):
                ...
                every = self.agent.update_skill_every_step // repeat
                init_step = self.agent.num_init_frames
                if self.global_step >= (
    ...
    def load_snapshot(self):
        ...
        def try_load(seed):
            ...
            with snapshot.open('rb') as f:
                payload = torch.load(f, map_location='cuda:1')
            return payload

        # try to load current seed1
